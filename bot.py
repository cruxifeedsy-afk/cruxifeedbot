...
ADMIN_USERNAME = os.environ.get("ADMIN_USERNAME")  # e.g., @KelvinTrading
ACCESS_CODES = os.environ.get("ACCESS_CODES", "").split(",")  # Comma-separated codes
ALPHA_KEY = os.environ.get("ALPHA_VANTAGE_KEY")

# ====== USER DATA ======
user_data_store = {}  # Store user selections
